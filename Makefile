...
# Go build flags
LDFLAGS=-X winterflow-agent/internal/package.version=${VERSION} -X winterflow-agent/internal/config.GRPCServerAddress=${GRPC_ADDR} -X winterflow-agent/internal/config.APIBaseURL=${API_URL}
BUILD_FLAGS=-v
