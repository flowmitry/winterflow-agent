...
func RegisterQueryHandlers(b cqrs.QueryBus, config *config.Config, ansible ansible.Repository) error {
	...
	if err := b.Register(get_apps_status.NewGetAppsStatusQueryHandler(ansible)); err != nil {
